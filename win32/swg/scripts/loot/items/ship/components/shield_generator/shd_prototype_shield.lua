shd_prototype_shield = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/shield_generator/shd_prototype_shield.iff",
	craftingValues = {
...
addLootItemTemplate("shd_prototype_shield", shd_prototype_shield)
