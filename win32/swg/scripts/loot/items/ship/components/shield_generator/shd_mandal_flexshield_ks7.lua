shd_mandal_flexshield_ks7 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/shield_generator/shd_mandal_flexshield_ks7.iff",
	craftingValues = {
		...
		{"ship_component_mass", 30898, 8570, 0},
...
addLootItemTemplate("shd_mandal_flexshield_ks7", shd_mandal_flexshield_ks7)
