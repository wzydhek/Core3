shd_koensayr_deflector_elite = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/shield_generator/shd_koensayr_deflector_elite.iff",
	craftingValues = {
		{"ship_component_shield_recharge_rate", 4.4, 23.4, 1},
...
addLootItemTemplate("shd_koensayr_deflector_elite", shd_koensayr_deflector_elite)
