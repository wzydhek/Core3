ddi_freitek_droid_commander_mk3 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/droid_interface/ddi_freitek_droid_commander_mk3.iff",
	craftingValues = {
...
addLootItemTemplate("ddi_freitek_droid_commander_mk3", ddi_freitek_droid_commander_mk3)
