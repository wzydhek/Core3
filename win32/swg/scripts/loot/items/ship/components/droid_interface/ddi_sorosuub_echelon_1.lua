ddi_sorosuub_echelon_1 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/droid_interface/ddi_sorosuub_echelon_1.iff",
	craftingValues = {
...
addLootItemTemplate("ddi_sorosuub_echelon_1", ddi_sorosuub_echelon_1)
