ddi_qualdex_droid_interface_mk4 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/droid_interface/ddi_qualdex_droid_interface_mk4.iff",
	craftingValues = {
...
addLootItemTemplate("ddi_qualdex_droid_interface_mk4", ddi_qualdex_droid_interface_mk4)
