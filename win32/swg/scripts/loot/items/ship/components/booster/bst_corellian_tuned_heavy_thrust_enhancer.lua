bst_corellian_tuned_heavy_thrust_enhancer = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_corellian_tuned_heavy_thrust_enhancer.iff",
	craftingValues = {
...
addLootItemTemplate("bst_corellian_tuned_heavy_thrust_enhancer", bst_corellian_tuned_heavy_thrust_enhancer)
