bst_surronian_accelerator_mk1 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_surronian_accelerator_mk1.iff",
	craftingValues = {
...
addLootItemTemplate("bst_surronian_accelerator_mk1", bst_surronian_accelerator_mk1)
