bst_sorosuub_liberator_mk5 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_sorosuub_liberator_mk5.iff",
	craftingValues = {
...
addLootItemTemplate("bst_sorosuub_liberator_mk5", bst_sorosuub_liberator_mk5)
