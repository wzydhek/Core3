bst_sorosuub_supercharged_liberator_mk3 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_sorosuub_supercharged_liberator_mk3.iff",
	craftingValues = {
...
addLootItemTemplate("bst_sorosuub_supercharged_liberator_mk3", bst_sorosuub_supercharged_liberator_mk3)
