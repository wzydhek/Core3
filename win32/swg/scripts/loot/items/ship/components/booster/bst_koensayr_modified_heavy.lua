bst_koensayr_modified_heavy = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_koensayr_modified_heavy.iff",
	craftingValues = {
...
addLootItemTemplate("bst_koensayr_modified_heavy", bst_koensayr_modified_heavy)
