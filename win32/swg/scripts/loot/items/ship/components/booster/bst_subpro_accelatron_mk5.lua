bst_subpro_accelatron_mk5 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_subpro_accelatron_mk5.iff",
	craftingValues = {
...
addLootItemTemplate("bst_subpro_accelatron_mk5", bst_subpro_accelatron_mk5)
