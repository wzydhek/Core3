bst_subpro_deluxe_accelatron_mk3 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_subpro_deluxe_accelatron_mk3.iff",
	craftingValues = {
...
addLootItemTemplate("bst_subpro_deluxe_accelatron_mk3", bst_subpro_deluxe_accelatron_mk3)
