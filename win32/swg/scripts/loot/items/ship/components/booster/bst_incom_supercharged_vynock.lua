bst_incom_supercharged_vynock = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_incom_supercharged_vynock.iff",
	craftingValues = {
...
addLootItemTemplate("bst_incom_supercharged_vynock", bst_incom_supercharged_vynock)
