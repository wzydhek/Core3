bst_novaldex_pulsar_advanced = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_novaldex_pulsar_advanced.iff",
	craftingValues = {
...
addLootItemTemplate("bst_novaldex_pulsar_advanced", bst_novaldex_pulsar_advanced)
