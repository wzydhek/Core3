bst_mandal_improved_jbj_mk3 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_mandal_improved_jbj_mk3.iff",
	craftingValues = {
...
addLootItemTemplate("bst_mandal_improved_jbj_mk3", bst_mandal_improved_jbj_mk3)
