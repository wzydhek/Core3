bst_koensayr_racer_mk3 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/booster/bst_koensayr_racer_mk3.iff",
	craftingValues = {
...
addLootItemTemplate("bst_koensayr_racer_mk3", bst_koensayr_racer_mk3)
