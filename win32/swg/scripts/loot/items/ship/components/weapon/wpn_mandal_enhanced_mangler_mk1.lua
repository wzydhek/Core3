wpn_mandal_enhanced_mangler_mk1 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_mandal_enhanced_mangler_mk1.iff",
	craftingValues = {
		{"ship_component_weapon_damage_minimum", 257.2, 489.6, 1},
		{"ship_component_weapon_damage_maximum", 345.9, 658.4, 1},
...
addLootItemTemplate("wpn_mandal_enhanced_mangler_mk1", wpn_mandal_enhanced_mangler_mk1)
