wpn_mandal_annilhator_mk1 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_mandal_annilhator_mk1.iff",
	craftingValues = {
		{"ship_component_weapon_damage_minimum", 835.4, 1930.9, 1},
		{"ship_component_weapon_damage_maximum", 1233, 2849.8, 1},
		...
		{"ship_component_mass", 17796, 6239, 0},
...
addLootItemTemplate("wpn_mandal_annilhator_mk1", wpn_mandal_annilhator_mk1)
