wpn_koensayr_ion_accelerator = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_koensayr_ion_accelerator.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_koensayr_ion_accelerator", wpn_koensayr_ion_accelerator)
