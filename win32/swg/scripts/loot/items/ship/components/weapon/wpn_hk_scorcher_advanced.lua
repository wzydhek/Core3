wpn_hk_scorcher_advanced = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_hk_scorcher_advanced.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_hk_scorcher_advanced", wpn_hk_scorcher_advanced)
