wpn_kessel_rebel_riiz_combine_slammer_cannon = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_kessel_rebel_riiz_combine_slammer_cannon.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_kessel_rebel_riiz_combine_slammer_cannon", wpn_kessel_rebel_riiz_combine_slammer_cannon)
