wpn_haor_chall_speedblaster = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_haor_chall_speedblaster.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_haor_chall_speedblaster", wpn_haor_chall_speedblaster)
