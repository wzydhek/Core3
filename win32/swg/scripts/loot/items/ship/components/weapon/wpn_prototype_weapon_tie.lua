wpn_prototype_weapon_tie = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_prototype_weapon_tie.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_prototype_weapon_tie", wpn_prototype_weapon_tie)
