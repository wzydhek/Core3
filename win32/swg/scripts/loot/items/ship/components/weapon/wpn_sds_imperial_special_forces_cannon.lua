wpn_sds_imperial_special_forces_cannon = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_sds_imperial_special_forces_cannon.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_sds_imperial_special_forces_cannon", wpn_sds_imperial_special_forces_cannon)
