wpn_koensayr_deluxe_ion_accelerator = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_koensayr_deluxe_ion_accelerator.iff",
	craftingValues = {
		...
		{"ship_component_hitpoints", 333.2, 443.1, 1},
		{"ship_component_armor", 166.6, 221.6, 1},
		{"ship_component_energy_required", 3110, 1090, 0},
		{"ship_component_mass", 6155, 2157, 0},
...
addLootItemTemplate("wpn_koensayr_deluxe_ion_accelerator", wpn_koensayr_deluxe_ion_accelerator)
