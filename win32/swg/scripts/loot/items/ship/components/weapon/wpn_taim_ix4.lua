wpn_taim_ix4 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_taim_ix4.iff",
	craftingValues = {
		...
		{"ship_component_energy_required", 3021, 1059, 0},
		{"ship_component_mass", 6609, 2316, 0},
...
addLootItemTemplate("wpn_taim_ix4", wpn_taim_ix4)
