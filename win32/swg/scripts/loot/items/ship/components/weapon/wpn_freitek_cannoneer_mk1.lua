wpn_freitek_cannoneer_mk1 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_freitek_cannoneer_mk1.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_freitek_cannoneer_mk1", wpn_freitek_cannoneer_mk1)
