wpn_kessel_imperial_rendili_prototype_x = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_kessel_imperial_rendili_prototype_x.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_kessel_imperial_rendili_prototype_x", wpn_kessel_imperial_rendili_prototype_x)
