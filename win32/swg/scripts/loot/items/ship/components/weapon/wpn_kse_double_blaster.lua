wpn_kse_double_blaster = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_kse_double_blaster.iff",
	craftingValues = {
		...
		{"ship_component_hitpoints", 266.5, 354.5, 1},
		{"ship_component_armor", 133.2, 177.3, 1},
		{"ship_component_energy_required", 3110, 1090, 0},
		{"ship_component_mass", 3517, 1233, 0},
...
addLootItemTemplate("wpn_kse_double_blaster", wpn_kse_double_blaster)
