wpn_sds_imperial_blaster_2 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_sds_imperial_blaster_2.iff",
	craftingValues = {
		...
		{"ship_component_hitpoints", 749.4, 996.3, 1},
		{"ship_component_armor", 374.7, 498.2, 1},
		{"ship_component_energy_required", 3258, 1142, 0},
		{"ship_component_mass", 19414, 6806, 0},
...
addLootItemTemplate("wpn_sds_imperial_blaster_2", wpn_sds_imperial_blaster_2)
