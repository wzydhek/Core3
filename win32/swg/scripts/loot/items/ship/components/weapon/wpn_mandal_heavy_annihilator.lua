wpn_mandal_heavy_annihilator = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_mandal_heavy_annihilator.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_mandal_heavy_annihilator", wpn_mandal_heavy_annihilator)
