wpn_subpro_improved_light_ioncannon = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_subpro_improved_light_ioncannon.iff",
	craftingValues = {
		...
		{"ship_component_mass", 2514, 881, 0},
...
addLootItemTemplate("wpn_subpro_improved_light_ioncannon", wpn_subpro_improved_light_ioncannon)
