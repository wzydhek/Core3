wpn_seinar_linked_cannon = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_seinar_linked_cannon.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_seinar_linked_cannon", wpn_seinar_linked_cannon)
