wpn_cygnus_destroyer_mk1 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_cygnus_destroyer_mk1.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_cygnus_destroyer_mk1", wpn_cygnus_destroyer_mk1)
