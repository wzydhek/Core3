wpn_armek_sw6 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_armek_sw6.iff",
	craftingValues = {
		...
		{"ship_component_mass", 17149, 6012, 0},
...
addLootItemTemplate("wpn_armek_sw6", wpn_armek_sw6)
