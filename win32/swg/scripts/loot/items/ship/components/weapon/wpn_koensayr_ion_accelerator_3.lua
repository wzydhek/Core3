wpn_koensayr_ion_accelerator_3 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_koensayr_ion_accelerator_3.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_koensayr_ion_accelerator_3", wpn_koensayr_ion_accelerator_3)
