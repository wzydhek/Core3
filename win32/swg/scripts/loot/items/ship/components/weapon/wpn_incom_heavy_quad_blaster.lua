wpn_incom_heavy_quad_blaster = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_incom_heavy_quad_blaster.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_incom_heavy_quad_blaster", wpn_incom_heavy_quad_blaster)
