wpn_sds_modified_elite = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_sds_modified_elite.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_sds_modified_elite", wpn_sds_modified_elite)
