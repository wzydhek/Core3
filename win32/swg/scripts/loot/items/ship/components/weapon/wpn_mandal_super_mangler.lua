wpn_mandal_super_mangler = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_mandal_super_mangler.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_mandal_super_mangler", wpn_mandal_super_mangler)
