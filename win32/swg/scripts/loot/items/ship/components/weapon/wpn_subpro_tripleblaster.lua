wpn_subpro_tripleblaster = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_subpro_tripleblaster.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_subpro_tripleblaster", wpn_subpro_tripleblaster)
