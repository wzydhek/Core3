wpn_mandal_annihilator_mk2 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_mandal_annihilator_mk2.iff",
	craftingValues = {
		...
		{"ship_component_mass", 26567, 9313, 0},
...
addLootItemTemplate("wpn_mandal_annihilator_mk2", wpn_mandal_annihilator_mk2)
