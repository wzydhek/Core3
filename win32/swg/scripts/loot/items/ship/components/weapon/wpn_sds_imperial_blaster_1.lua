wpn_sds_imperial_blaster_1 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_sds_imperial_blaster_1.iff",
	craftingValues = {
		...
		{"ship_component_hitpoints", 141.6, 188.4, 1},
		{"ship_component_armor", 70.8, 94.2, 1},
		{"ship_component_energy_required", 2962, 1038, 0},
		{"ship_component_mass", 1629, 571, 0},
...
addLootItemTemplate("wpn_sds_imperial_blaster_1", wpn_sds_imperial_blaster_1)
