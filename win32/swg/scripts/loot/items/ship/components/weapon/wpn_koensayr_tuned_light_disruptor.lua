wpn_koensayr_tuned_light_disruptor = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_koensayr_tuned_light_disruptor.iff",
	craftingValues = {
		{"ship_component_weapon_damage_minimum", 239.4, 485.6, 1},
		{"ship_component_weapon_damage_maximum", 322, 653, 1},
		{"ship_component_weapon_effectiveness_shields", 321, 429, 3},
		{"ship_component_weapon_effectiveness_armor", 751, 999, 3},
...
addLootItemTemplate("wpn_koensayr_tuned_light_disruptor", wpn_koensayr_tuned_light_disruptor)
