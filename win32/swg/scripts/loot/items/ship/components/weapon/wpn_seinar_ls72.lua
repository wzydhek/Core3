wpn_seinar_ls72 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_seinar_ls72.iff",
	craftingValues = {
		...
		{"ship_component_mass", 90479, 31721, 0},
...
addLootItemTemplate("wpn_seinar_ls72", wpn_seinar_ls72)
