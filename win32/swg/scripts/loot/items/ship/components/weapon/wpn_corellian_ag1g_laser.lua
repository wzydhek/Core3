wpn_corellian_ag1g_laser = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_corellian_ag1g_laser.iff",
	craftingValues = {
		{"ship_component_weapon_damage_minimum", 1182.9, 2398.7, 1},
		{"ship_component_weapon_damage_maximum", 1829.1, 3708.9, 1},
...
addLootItemTemplate("wpn_corellian_ag1g_laser", wpn_corellian_ag1g_laser)
