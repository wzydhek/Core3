wpn_gyrhil_auto_blaster = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_gyrhil_auto_blaster.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_gyrhil_auto_blaster", wpn_gyrhil_auto_blaster)
