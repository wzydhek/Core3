wpn_kessel_imperial_sfs_elite_ops = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_kessel_imperial_sfs_elite_ops.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_kessel_imperial_sfs_elite_ops", wpn_kessel_imperial_sfs_elite_ops)
