wpn_slayn_light_ioncannon = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/weapon/wpn_slayn_light_ioncannon.iff",
	craftingValues = {
...
addLootItemTemplate("wpn_slayn_light_ioncannon", wpn_slayn_light_ioncannon)
