eng_freitek_dual_jet = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_freitek_dual_jet.iff",
	craftingValues = {
...
addLootItemTemplate("eng_freitek_dual_jet", eng_freitek_dual_jet)
