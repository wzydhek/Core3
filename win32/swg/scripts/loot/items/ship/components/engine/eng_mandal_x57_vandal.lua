eng_mandal_x57_vandal = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_mandal_x57_vandal.iff",
	craftingValues = {
...
addLootItemTemplate("eng_mandal_x57_vandal", eng_mandal_x57_vandal)
