eng_kessel_imperial_sds_special_forces = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_kessel_imperial_sds_special_forces.iff",
	craftingValues = {
...
addLootItemTemplate("eng_kessel_imperial_sds_special_forces", eng_kessel_imperial_sds_special_forces)
