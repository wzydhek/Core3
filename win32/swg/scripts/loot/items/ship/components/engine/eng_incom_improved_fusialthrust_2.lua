eng_incom_improved_fusialthrust_2 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_incom_improved_fusialthrust_2.iff",
	craftingValues = {
...
addLootItemTemplate("eng_incom_improved_fusialthrust_2", eng_incom_improved_fusialthrust_2)
