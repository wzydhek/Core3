eng_sds_imperial_2 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_sds_imperial_2.iff",
	craftingValues = {
		{"ship_component_engine_speed_maximum", 32.1, 57.5, 1},
		...
		{"ship_component_mass", 7460, 3227, 0},
...
addLootItemTemplate("eng_sds_imperial_2", eng_sds_imperial_2)
