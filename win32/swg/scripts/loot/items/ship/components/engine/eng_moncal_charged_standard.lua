eng_moncal_charged_standard = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_moncal_charged_standard.iff",
	craftingValues = {
...
addLootItemTemplate("eng_moncal_charged_standard", eng_moncal_charged_standard)
