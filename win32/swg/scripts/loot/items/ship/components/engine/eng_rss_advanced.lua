eng_rss_advanced = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_rss_advanced.iff",
	craftingValues = {
		{"ship_component_engine_speed_maximum", 40.2, 72.1, 1},
		...
		{"ship_component_mass", 51449, 22261, 0},
...
addLootItemTemplate("eng_rss_advanced", eng_rss_advanced)
