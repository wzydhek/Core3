eng_rendili_demon_mk1 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_rendili_demon_mk1.iff",
	craftingValues = {
...
addLootItemTemplate("eng_rendili_demon_mk1", eng_rendili_demon_mk1)
