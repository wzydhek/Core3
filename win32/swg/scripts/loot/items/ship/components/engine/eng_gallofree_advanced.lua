eng_gallofree_advanced = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_gallofree_advanced.iff",
	craftingValues = {
...
addLootItemTemplate("eng_gallofree_advanced", eng_gallofree_advanced)
