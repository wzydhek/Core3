engine_incom_fusialthrust = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/engine_incom_fusialthrust.iff",
	craftingValues = {
...
addLootItemTemplate("engine_incom_fusialthrust", engine_incom_fusialthrust)
