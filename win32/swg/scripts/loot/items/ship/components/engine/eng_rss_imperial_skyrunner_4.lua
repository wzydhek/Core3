eng_rss_imperial_skyrunner_4 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_rss_imperial_skyrunner_4.iff",
	craftingValues = {
		...
		{"ship_component_mass", 37730, 16324, 0},
...
addLootItemTemplate("eng_rss_imperial_skyrunner_4", eng_rss_imperial_skyrunner_4)
