eng_koensayr_enhanced_dual_small_ionjet = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_koensayr_enhanced_dual_small_ionjet.iff",
	craftingValues = {
...
addLootItemTemplate("eng_koensayr_enhanced_dual_small_ionjet", eng_koensayr_enhanced_dual_small_ionjet)
