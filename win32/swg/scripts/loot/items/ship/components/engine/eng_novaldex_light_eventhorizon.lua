eng_novaldex_light_eventhorizon = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_novaldex_light_eventhorizon.iff",
	craftingValues = {
...
addLootItemTemplate("eng_novaldex_light_eventhorizon", eng_novaldex_light_eventhorizon)
