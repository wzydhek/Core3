eng_kessel_rebel_incom_t11_elite = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_kessel_rebel_incom_t11_elite.iff",
	craftingValues = {
...
addLootItemTemplate("eng_kessel_rebel_incom_t11_elite", eng_kessel_rebel_incom_t11_elite)
