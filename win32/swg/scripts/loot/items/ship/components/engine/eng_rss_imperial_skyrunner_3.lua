eng_rss_imperial_skyrunner_3 = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_rss_imperial_skyrunner_3.iff",
	craftingValues = {
		{"ship_component_engine_speed_maximum", 35.9, 64.4, 1},
		...
		{"ship_component_mass", 19600, 8480, 0},
...
addLootItemTemplate("eng_rss_imperial_skyrunner_3", eng_rss_imperial_skyrunner_3)
