eng_novaldex_x9 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_novaldex_x9.iff",
	craftingValues = {
		{"ship_component_engine_speed_maximum", 55.5, 99.4, 1},
...
addLootItemTemplate("eng_novaldex_x9", eng_novaldex_x9)
