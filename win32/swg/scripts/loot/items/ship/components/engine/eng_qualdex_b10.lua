eng_qualdex_b10 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_qualdex_b10.iff",
	craftingValues = {
		{"ship_component_engine_speed_maximum", 46.5, 83.3, 1},
		...
		{"ship_component_mass", 26460, 11448, 0},
...
addLootItemTemplate("eng_qualdex_b10", eng_qualdex_b10)
