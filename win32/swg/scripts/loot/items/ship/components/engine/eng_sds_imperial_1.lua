eng_sds_imperial_1 = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_sds_imperial_1.iff",
	craftingValues = {
		{"ship_component_engine_speed_maximum", 33.1, 59.3, 1},
		...
		{"ship_component_mass", 1508, 652, 0},
...
addLootItemTemplate("eng_sds_imperial_1", eng_sds_imperial_1)
