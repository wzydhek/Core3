eng_prototype_engine = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/ship/components/engine/eng_prototype_engine.iff",
	craftingValues = {
...
addLootItemTemplate("eng_prototype_engine", eng_prototype_engine)
