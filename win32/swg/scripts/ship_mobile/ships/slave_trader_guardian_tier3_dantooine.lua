slave_trader_guardian_tier3_dantooine = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(slave_trader_guardian_tier3_dantooine, "slave_trader_guardian_tier3_dantooine")
