dantooine_slave_trader_boss_tier3 = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(dantooine_slave_trader_boss_tier3, "dantooine_slave_trader_boss_tier3")
