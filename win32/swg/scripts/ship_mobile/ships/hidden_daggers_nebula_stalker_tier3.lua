hidden_daggers_nebula_stalker_tier3 = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(hidden_daggers_nebula_stalker_tier3, "hidden_daggers_nebula_stalker_tier3")
