dath_witchblood_clan_soldier_tier1 = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(dath_witchblood_clan_soldier_tier1, "dath_witchblood_clan_soldier_tier1")
