dath_witchblood_clan_soldier_tier3 = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(dath_witchblood_clan_soldier_tier3, "dath_witchblood_clan_soldier_tier3")
