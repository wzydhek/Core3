hidden_daggers_nebula_stalker_tier1 = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(hidden_daggers_nebula_stalker_tier1, "hidden_daggers_nebula_stalker_tier1")
