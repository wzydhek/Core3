...
ThrowTrapTask::ThrowTrapTask(CreatureObject* attacker, CreatureObject* target, TangibleObject* trap) : Task() {
...
ThrowTrapTask::~ThrowTrapTask() {
}

void ThrowTrapTask::run() {
