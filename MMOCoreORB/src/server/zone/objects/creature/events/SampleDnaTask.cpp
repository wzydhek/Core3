#include "SampleDnaTask.h"
#include "server/zone/managers/player/PlayerManager.h"

SampleDnaTask::SampleDnaTask(Creature* cre, CreatureObject* playo) : Task() {
	currentPhase = BEGIN;
	waitCount = 0;
	creature = cre;
	player = playo;
...
void SampleDnaTask::killCreature() {
	int dam = 9999999;
...
void SampleDnaTask::award(int cl, float rollMod, int skillMod) {
