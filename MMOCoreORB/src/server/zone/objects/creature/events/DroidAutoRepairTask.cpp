#include "DroidAutoRepairTask.h"

DroidAutoRepairTask::DroidAutoRepairTask(DroidAutoRepairModuleDataComponent* module) : Task() {
	this->module = module;
}

void DroidAutoRepairTask::run() {
...
void DroidAutoRepairTask::healDroid(DroidObject* healer, DroidObject* droid, int amount) {
