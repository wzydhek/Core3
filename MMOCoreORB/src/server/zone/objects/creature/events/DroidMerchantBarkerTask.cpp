#include "DroidMerchantBarkerTask.h"

DroidMerchantBarkerTask::DroidMerchantBarkerTask(DroidMerchantModuleDataComponent* module) : Task() {
	this->module = module;
}

void DroidMerchantBarkerTask::run() {
	if (module == nullptr) {
		return;
	}
