#include "SampleDeedTask.h"
#include "server/zone/managers/player/PlayerManager.h"

SampleDeedTask::SampleDeedTask(PetDeed* obj, CreatureObject* playo) : Task() {
	currentPhase = BEGIN;
	waitCount = 0;
	deed = obj;
	player = playo;
...
void SampleDeedTask::award(int cl, float rollMod) {
