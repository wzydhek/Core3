#include "TameCreatureTask.h"
#include "server/zone/objects/creature/ai/Creature.h"
#include "server/zone/objects/player/PlayerObject.h"
#include "server/zone/managers/object/ObjectManager.h"
#include "server/zone/managers/player/PlayerManager.h"

TameCreatureTask::TameCreatureTask(Creature* cre, CreatureObject* playo, int pvpMask, bool forced, bool adults) : Task() {
...
void TameCreatureTask::success(bool adult) {
	ManagedReference<CreatureObject*> player = play.get();
	ManagedReference<Creature*> creature = mob.get();
...
void TameCreatureTask::resetStatus() {
	ManagedReference<Creature*> creature = mob.get();
