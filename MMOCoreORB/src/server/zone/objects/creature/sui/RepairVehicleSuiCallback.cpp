#include "RepairVehicleSuiCallback.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"	
#include "server/zone/objects/creature/CreatureObject.h"
#include "server/zone/objects/player/PlayerObject.h"
#include "server/zone/objects/region/CityRegion.h"

RepairVehicleSuiCallback::RepairVehicleSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void RepairVehicleSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
