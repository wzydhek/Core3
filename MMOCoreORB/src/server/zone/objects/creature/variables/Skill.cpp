...
int Skill::compareTo(const Skill& s) {
	return skillName.compareTo(s.skillName);
}

int Skill::compareTo(Skill* s) {
	return skillName.compareTo(s->skillName);
}

void Skill::parseDataTableRow(DataTableRow* row) {
...
void Skill::parseLuaObject(LuaObject* templateData) {
...
int Skill::getJediStateRequired() const {
	return jediStateRequired;
}

bool Skill::isGodOnly() const {
	return godOnly;
}

bool Skill::isTitle() const {
	return title;
}

bool Skill::isSkill() const {
	return profession;
}
...
int Skill::getTotalChildren() const {
	return childNodes.size();
}

const Skill* Skill::getChildNode(int idx) const {
	return childNodes.get(idx);
}

bool Skill::containsChildNode(Skill* skill) const {
	return childNodes.contains(skill);
}

const String& Skill::getParentName() const {
	return parentName;
}

void Skill::addChild(Skill* skill) {
	skill->setParentNode(this);
	childNodes.add(skill);
}

const Vector<String>* Skill::getAbilities() const {
	return &commands;
}

const Vector<String>* Skill::getSchematicsGranted() const {
	return &schematicsGranted;
}

const VectorMap<String, int>* Skill::getSkillModifiers() const {
	return &skillModifiers;
}

const Vector<String>* Skill::getSkillsRequired() const {
	return &skillsRequired;
}

bool Skill::isRequiredSkillOf(Skill* skill) const {
	return skillsRequired.contains(skill->getSkillName());
}

const String& Skill::getXpType() const {
	return xpType;
}

int Skill::getXpCap() const {
	return xpCap;
}
 ...
 */
int Skill::getMoneyRequired() const {
 ...
 */
int Skill::getSkillPointsRequired() const {
 ...
 */
const Vector<String>* Skill::getSpeciesRequired() const {
	return &speciesRequired;
}

void Skill::setParentNode(Skill* skill) {
	parentNode = skill;
}

void Skill::parseSkillMods(const String& modstring) {
