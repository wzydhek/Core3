#include "InstallMissionTerminalSuiCallback.h"
...
InstallMissionTerminalSuiCallback::InstallMissionTerminalSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void InstallMissionTerminalSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
