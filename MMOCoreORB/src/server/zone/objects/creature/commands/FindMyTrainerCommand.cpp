...
FindMyTrainerCommand::FindMyTrainerCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int FindMyTrainerCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
void FindMyTrainerCommand::setJediTrainer(ZoneServer* zoneServer, PlayerObject* ghost) const {
