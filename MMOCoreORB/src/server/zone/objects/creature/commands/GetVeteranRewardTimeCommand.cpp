...
GetVeteranRewardTimeCommand::GetVeteranRewardTimeCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int GetVeteranRewardTimeCommand::doQueueCommand(CreatureObject* player, const uint64& target, const UnicodeString& arguments) const {
