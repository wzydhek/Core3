...
SetRetreatCommand::SetRetreatCommand(const String& name, ZoneProcessServer* server) : SquadLeaderCommand(name, server) {
}

int SetRetreatCommand::doQueueCommand(CreatureObject* creature, /*Skill* skill,*/ const uint64& target, const UnicodeString& arguments) const {
