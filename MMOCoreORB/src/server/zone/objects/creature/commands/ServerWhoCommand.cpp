...
int ServerWhoCommand::executeCommand(CreatureObject* creature, uint64 target, const UnicodeString& arguments) {
	if (creature == nullptr)
		return 1;
...
void ServerWhoCommand::sendSyntax(CreatureObject* player) {
	if (player != nullptr)
