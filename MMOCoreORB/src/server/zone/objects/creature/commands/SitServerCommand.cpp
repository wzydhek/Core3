...
SitServerCommand::SitServerCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int SitServerCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
int SitServerCommand::setPlayerPosture(CreatureObject* creature) const {
