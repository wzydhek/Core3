...
UnconsentCommand::UnconsentCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

void UnconsentCommand::unconscent(CreatureObject* player, CreatureObject* targetPlayer) {
...
int UnconsentCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
