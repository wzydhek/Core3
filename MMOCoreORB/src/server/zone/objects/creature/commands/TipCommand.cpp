...
TipCommand::TipCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int TipCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
int TipCommand::performTip(CreatureObject* player, CreatureObject* targetPlayer, int amount) const {
...
int TipCommand::performBankTip(CreatureObject* player, CreatureObject* targetPlayer, int amount) const {
