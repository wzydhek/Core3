...
StartMusicCommand::StartMusicCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

void StartMusicCommand::startMusic(CreatureObject* creature, int performanceIndex, Instrument* instrument) {
...
int StartMusicCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
