...
GetAccountInfoCommand::GetAccountInfoCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int GetAccountInfoCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
void GetAccountInfoCommand::sendUsage(CreatureObject* creature) const {
