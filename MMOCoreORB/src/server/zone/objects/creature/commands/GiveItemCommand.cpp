...
GiveItemCommand::GiveItemCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int GiveItemCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
bool GiveItemCommand::giveItemToVendor(CreatureObject* player, CreatureObject* vendor, TangibleObject* giveItem) const {
...
bool GiveItemCommand::giveItemToActorNpc(CreatureObject* player, CreatureObject* npcActor, TangibleObject* giveItem) const {
