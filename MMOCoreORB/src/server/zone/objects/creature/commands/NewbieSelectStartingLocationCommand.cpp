...
NewbieSelectStartingLocationCommand::NewbieSelectStartingLocationCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int NewbieSelectStartingLocationCommand::doQueueCommand(CreatureObject* player, const uint64& target, const UnicodeString& arguments) const {
