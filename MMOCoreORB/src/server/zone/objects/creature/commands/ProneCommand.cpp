...
ProneCommand::ProneCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int ProneCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
int ProneCommand::setAiAgentPosture(CreatureObject* creature) const {
...
int ProneCommand::setPlayerPosture(CreatureObject* creature) const {
