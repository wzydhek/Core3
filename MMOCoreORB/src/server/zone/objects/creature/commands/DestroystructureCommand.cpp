...
DestroystructureCommand::DestroystructureCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int DestroystructureCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
int DestroystructureCommand::disbandCamp(CreatureObject* creature, StructureObject* structure) const {
