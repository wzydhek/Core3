...
DelegateFactionPointsCommand::DelegateFactionPointsCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int DelegateFactionPointsCommand::doDelegate(CreatureObject* creature, CreatureObject* targetPlayer, uint32 tipAmount) {
...
int DelegateFactionPointsCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
