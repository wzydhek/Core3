...
PermissionListModifyCommand::PermissionListModifyCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int PermissionListModifyCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
int PermissionListModifyCommand::handleStructurePermissions(CreatureObject* creature, SceneObject* sceneO, String targetName, String listName, String action, String arguments) const {
...
int PermissionListModifyCommand::handlePobShipPermissions(CreatureObject* creature, SceneObject* sceneO, String targetName, String listName, String action, String arguments) const {
	if (creature == nullptr || sceneO == nullptr)
		return GENERALERROR;
