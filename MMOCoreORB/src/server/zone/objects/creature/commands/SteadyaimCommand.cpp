...
SteadyaimCommand::SteadyaimCommand(const String& name, ZoneProcessServer* server) : SquadLeaderCommand(name, server) {
}

int SteadyaimCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
bool SteadyaimCommand::doSteadyAim(CreatureObject* leader, GroupObject* group, int amount) const {
