...
int WeatherCommand::executeCommand(CreatureObject* creature, uint64 target, const UnicodeString& arguments) {
...
void WeatherCommand::sendSyntax(CreatureObject* player) {
	if (player != nullptr)
