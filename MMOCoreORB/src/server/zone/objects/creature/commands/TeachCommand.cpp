...
TeachCommand::TeachCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int TeachCommand::doQueueCommand(CreatureObject* teacher, const uint64& target, const UnicodeString& arguments) const {
