...
AssociateDroidControlDeviceWithShipCommand::AssociateDroidControlDeviceWithShipCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int AssociateDroidControlDeviceWithShipCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
