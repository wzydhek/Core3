...
int PathFindCommand::executeCommand(CreatureObject* creature, uint64 target, const UnicodeString& arguments) {
...
void PathFindCommand::sendSyntax(CreatureObject* player) {
