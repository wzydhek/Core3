...
InsertItemIntoShipComponentSlotCommand::InsertItemIntoShipComponentSlotCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int InsertItemIntoShipComponentSlotCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
