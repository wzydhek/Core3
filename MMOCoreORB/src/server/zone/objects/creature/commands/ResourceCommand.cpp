...
ResourceCommand::ResourceCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int ResourceCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
void ResourceCommand::listResources(CreatureObject* creature, StringTokenizer* args) const {
...
void ResourceCommand::healthCheck(CreatureObject* creature, StringTokenizer* args) const {
	if (creature->getZoneServer() == nullptr)
		return;
...
void ResourceCommand::dumpResources(CreatureObject* creature, StringTokenizer* args) const {
	if (creature->getZoneServer() == nullptr)
		return;
...
void ResourceCommand::despawnResource(CreatureObject* creature, StringTokenizer* args) const {
	if (creature->getZoneServer() == nullptr)
		return;
...
void ResourceCommand::listResourceInfo(CreatureObject* creature, StringTokenizer* args) const {
	if (creature->getZoneServer() == nullptr)
		return;
...
void ResourceCommand::findResources(CreatureObject* creature, StringTokenizer* args) const {
...
void ResourceCommand::giveResource(CreatureObject* creature, StringTokenizer* args) const {
	if (creature->getZoneServer() == nullptr || !args->hasMoreTokens())
		throw Exception();
