#include "PetGetPatrolPointCommand.h"
...
PetGetPatrolPointCommand::PetGetPatrolPointCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int PetGetPatrolPointCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
