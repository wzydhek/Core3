#include "PetRangedAttackCommand.h"
...
PetRangedAttackCommand::PetRangedAttackCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int PetRangedAttackCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
