#include "PetRechargeOtherCommand.h"
#include "server/zone/objects/intangible/PetControlDevice.h"
#include "server/zone/ZoneServer.h"
#include "server/zone/managers/creature/PetManager.h"
#include "server/zone/objects/creature/ai/DroidObject.h"

PetRechargeOtherCommand::PetRechargeOtherCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int PetRechargeOtherCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
