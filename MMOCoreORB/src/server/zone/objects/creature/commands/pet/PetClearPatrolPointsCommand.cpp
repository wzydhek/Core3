#include "PetClearPatrolPointsCommand.h"
...
PetClearPatrolPointsCommand::PetClearPatrolPointsCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int PetClearPatrolPointsCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
