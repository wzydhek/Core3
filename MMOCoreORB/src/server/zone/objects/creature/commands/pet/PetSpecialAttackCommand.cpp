#include "PetSpecialAttackCommand.h"
...
PetSpecialAttackCommand::PetSpecialAttackCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int PetSpecialAttackCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
