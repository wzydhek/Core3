...
CreateCreatureCommand::CreateCreatureCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
}

int CreateCreatureCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
...
int CreateCreatureCommand::createShip(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
