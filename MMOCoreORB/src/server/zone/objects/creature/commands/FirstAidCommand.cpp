...
FirstAidCommand::FirstAidCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
	mindCost = 0;
	range = 6;
}

void FirstAidCommand::doAnimations(CreatureObject* creature, CreatureObject* creatureTarget) const {
...
void FirstAidCommand::sendCureMessage(CreatureObject* object, CreatureObject* target) const {
...
bool FirstAidCommand::canPerformSkill(CreatureObject* creature, CreatureObject* creatureTarget) const {
...
int FirstAidCommand::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
