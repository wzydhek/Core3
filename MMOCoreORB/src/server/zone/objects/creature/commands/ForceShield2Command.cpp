...
ForceShield2Command::ForceShield2Command(const String& name, ZoneProcessServer* server) : JediQueueCommand(name, server) {
...
int ForceShield2Command::doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
	return doJediSelfBuffCommand(creature);
}

void ForceShield2Command::handleBuff(SceneObject* creature, ManagedObject* object, int64 param) const {
