...
FireworkShowLaunchFireworkEvent::FireworkShowLaunchFireworkEvent(CreatureObject* player, FireworkObject* fireworkShow, FireworkShowDataComponent* fireworkShowData, StaticObject* worldFireworkShow) : Task(1000) {
...
void FireworkShowLaunchFireworkEvent::run() {
