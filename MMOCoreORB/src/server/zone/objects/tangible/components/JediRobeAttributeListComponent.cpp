#include "JediRobeAttributeListComponent.h"

void JediRobeAttributeListComponent::fillAttributeList(AttributeListMessage* alm, CreatureObject* creature, SceneObject* object) const {
