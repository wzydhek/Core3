...
RecycleResourceTask::RecycleResourceTask(RecycleTool* reco, TangibleObject* tano) : Task() {
	recycler = reco;
	insertedItem = tano;
	resource = nullptr;
	player = nullptr;
...
void RecycleResourceTask::removeFromRecycler(const String& reason) {
