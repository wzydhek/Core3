...
SpawnDensityMap::SpawnDensityMap() : Object(), Serializable() {
	addSerializableVariables();
}

SpawnDensityMap::SpawnDensityMap(const SpawnDensityMap& map) : Object(), Serializable() {
	seed = map.seed;
...
SpawnDensityMap::SpawnDensityMap(bool ore, short concentration, float minx, float maxx, float miny, float maxy) : Object(), Serializable() {
...
SpawnDensityMap& SpawnDensityMap::operator=(const SpawnDensityMap& map) {
	if (this == &map)
		return *this;
...
float SpawnDensityMap::getDensityAt(float x, float y) const {
	x -= minX;
	y = maxY - y;
...
void SpawnDensityMap::print() const {
 ...
 */
void SpawnDensityMap::initialize(bool ore, short concentration) {
 ...
 */
void SpawnDensityMap::addSerializableVariables() {
