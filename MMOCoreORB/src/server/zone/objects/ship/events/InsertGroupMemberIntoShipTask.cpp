#include "InsertGroupMemberIntoShipTask.h"

InsertGroupMembertIntoShipTask::InsertGroupMembertIntoShipTask(ShipObject* shipObj, uint64 memID, int arrangement) : shipObj(shipObj), memberID(memID), playerArrangement(arrangement) {
	setLoggingName("InsertPlayerToShipTask");
}

void InsertGroupMembertIntoShipTask::run() {
