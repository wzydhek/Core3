#include "HyperspaceToLocationTask.h"

HyperspaceToLocationTask::HyperspaceToLocationTask(CreatureObject* pl, ShipObject* ship, const String& zoneName, const Vector3& location) : Task() {
	play = pl;
...
void HyperspaceToLocationTask::run() {
...
#ifdef DEBUG_HYPERSPACE
void HyperspaceToLocationTask::startPacketLoggingForShip(ShipObject* shipObject) {
...
void HyperspaceToLocationTask::stopPacketLoggingForShip(ShipObject* shipObject) {
	auto zoneServer = shipObject->getZoneServer();
