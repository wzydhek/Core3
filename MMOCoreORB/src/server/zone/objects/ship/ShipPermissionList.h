...
public:
	ShipPermissionList();
	ShipPermissionList(const ShipPermissionList& spl);

	ShipPermissionList& operator=(const ShipPermissionList& list);
	...
	friend void to_json(nlohmann::json& j, const ShipPermissionList& p);
