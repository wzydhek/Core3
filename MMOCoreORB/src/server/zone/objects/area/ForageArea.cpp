...
ForageArea::ForageArea(short playerX, short playerY, const String& plt, int forageAreaType) {
	xCoord = playerX;
	yCoord = playerY;
	planet = plt;
...
int ForageArea::checkPermission(short playerX, short playerY, const String& playerPlanet, int forageAreaType) {
