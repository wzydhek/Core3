...
ForageAreaCollection::ForageAreaCollection(CreatureObject* player, short forageX, short forageY, const String& planet, int forageAreaType) {
...
bool ForageAreaCollection::checkForageAreas(short forageX, short forageY, const String& planet, int forageAreaType) {
