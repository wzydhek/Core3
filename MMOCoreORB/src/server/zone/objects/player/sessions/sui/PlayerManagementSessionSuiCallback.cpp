#include "PlayerManagementSessionSuiCallback.h"

PlayerManagementSessionSuiCallback::PlayerManagementSessionSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void PlayerManagementSessionSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
...
void PlayerManagementSessionSuiCallback::runAccountInfo(CreatureObject* player, SuiBox* suiBox, bool cancelPressed, Vector<UnicodeString>* args) {
...
uint32 PlayerManagementSessionSuiCallback::getPlayerGalaxyID(CreatureObject* player, SuiListBox* listBox, int index, String& galaxyName) {
	while (index > 0) {
		index--;
...
void PlayerManagementSessionSuiCallback::runDurationCallback(CreatureObject* player, SuiBox* suiBox, bool cancelPressed, Vector<UnicodeString>* args) {
	ManagedReference<Facade*> facade = player->getActiveSession(SessionFacadeType::PLAYERMANAGEMENT);
	ManagedReference<PlayerManagementSession*> session = cast<PlayerManagementSession*>(facade.get());
	ManagedReference<PlayerManager*> playerManager = server->getPlayerManager();
...
void PlayerManagementSessionSuiCallback::runReasonCallback(CreatureObject* player, SuiBox* suiBox, bool cancelPressed, Vector<UnicodeString>* args) {
	ManagedReference<Facade*> facade = player->getActiveSession(SessionFacadeType::PLAYERMANAGEMENT);
	ManagedReference<PlayerManagementSession*> session = cast<PlayerManagementSession*>(facade.get());
	ManagedReference<PlayerManager*> playerManager = server->getPlayerManager();
...
void PlayerManagementSessionSuiCallback::runSummaryCallback(CreatureObject* player, SuiBox* suiBox, bool cancelPressed, Vector<UnicodeString>* args) {
	ManagedReference<Facade*> facade = player->getActiveSession(SessionFacadeType::PLAYERMANAGEMENT);
	ManagedReference<PlayerManagementSession*> session = cast<PlayerManagementSession*>(facade.get());
	ManagedReference<PlayerManager*> playerManager = server->getPlayerManager();
...
void PlayerManagementSessionSuiCallback::runUnbanSummaryCallback(CreatureObject* player, SuiBox* suiBox, bool cancelPressed, Vector<UnicodeString>* args) {
	ManagedReference<Facade*> facade = player->getActiveSession(SessionFacadeType::PLAYERMANAGEMENT);
	ManagedReference<PlayerManagementSession*> session = cast<PlayerManagementSession*>(facade.get());
	ManagedReference<PlayerManager*> playerManager = server->getPlayerManager();
