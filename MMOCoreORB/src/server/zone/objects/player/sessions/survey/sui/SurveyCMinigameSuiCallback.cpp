#include "SurveyCMinigameSuiCallback.h"

SurveyCMinigameSuiCallback::SurveyCMinigameSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void SurveyCMinigameSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
