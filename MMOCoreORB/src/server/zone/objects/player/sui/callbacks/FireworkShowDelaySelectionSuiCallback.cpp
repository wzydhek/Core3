#include "FireworkShowDelaySelectionSuiCallback.h"

FireworkShowDelaySelectionSuiCallback::FireworkShowDelaySelectionSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void FireworkShowDelaySelectionSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
