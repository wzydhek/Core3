#include "EnclaveVotingTerminalSuiCallback.h"
#include "server/zone/objects/building/BuildingObject.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"
#include "server/zone/objects/player/PlayerObject.h"

EnclaveVotingTerminalSuiCallback::EnclaveVotingTerminalSuiCallback(ZoneServer* server, short type, short enclave, int rnk, bool selectRank) : SuiCallback(server) {
	enclaveType = enclave;
	suiType = type;
	rank = rnk;
...
void EnclaveVotingTerminalSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
