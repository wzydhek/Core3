#include "NameShipSuiCallback.h"
#include "server/zone/objects/intangible/ShipControlDevice.h"

NameShipSuiCallback::NameShipSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void NameShipSuiCallback::run(CreatureObject* player, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
	if (player == nullptr)
		return;
