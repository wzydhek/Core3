#include "StructurePayUncondemnMaintenanceSuiCallback.h"
#include "server/zone/objects/player/sui/messagebox/SuiMessageBox.h"
#include "server/zone/objects/structure/StructureObject.h"
#include "server/zone/objects/building/BuildingObject.h"

StructurePayUncondemnMaintenanceSuiCallback::StructurePayUncondemnMaintenanceSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void StructurePayUncondemnMaintenanceSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
