#include "RevokeConsentSuiCallback.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"
#include "server/zone/objects/player/PlayerObject.h"
#include "server/zone/managers/player/PlayerManager.h"

RevokeConsentSuiCallback::RevokeConsentSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void RevokeConsentSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
