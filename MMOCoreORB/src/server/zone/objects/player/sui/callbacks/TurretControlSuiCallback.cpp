#include "TurretControlSuiCallback.h"
#include "server/zone/Zone.h"

TurretControlSuiCallback::TurretControlSuiCallback(ZoneServer* server, TangibleObject* turret, TangibleObject* terminal) : SuiCallback(server) {
	turretObject = turret;
	turretControl = terminal;
}

void TurretControlSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
