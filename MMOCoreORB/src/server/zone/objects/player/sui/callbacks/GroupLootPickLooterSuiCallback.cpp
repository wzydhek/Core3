#include "GroupLootPickLooterSuiCallback.h"

GroupLootPickLooterSuiCallback::GroupLootPickLooterSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void GroupLootPickLooterSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
