#include "GotoSuiCallback.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"
#include "server/zone/Zone.h"

GotoSuiCallback::GotoSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void GotoSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
