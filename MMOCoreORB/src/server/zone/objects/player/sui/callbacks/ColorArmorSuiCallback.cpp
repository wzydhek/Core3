#include "ColorArmorSuiCallback.h"
#include "server/zone/objects/player/sui/colorbox/SuiColorBox.h"

ColorArmorSuiCallback::ColorArmorSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void ColorArmorSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
