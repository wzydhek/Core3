#include "BaseShutdownSuiCallback.h"
#include "server/zone/objects/player/sui/messagebox/SuiMessageBox.h"
#include "server/zone/managers/gcw/GCWManager.h"
#include "server/zone/Zone.h"

BaseShutdownSuiCallback::BaseShutdownSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void BaseShutdownSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
