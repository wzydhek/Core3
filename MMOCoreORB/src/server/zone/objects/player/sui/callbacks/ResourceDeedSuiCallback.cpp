#include "ResourceDeedSuiCallback.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"
#include "server/zone/objects/tangible/deed/resource/ResourceDeed.h"
#include "server/zone/managers/resource/ResourceManager.h"

ResourceDeedSuiCallback::ResourceDeedSuiCallback(ZoneServer* serv, const String& name) : SuiCallback(serv) {
	nodeName = name;
}

void ResourceDeedSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
