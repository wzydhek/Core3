#include "InsuranceAllConfirmSuiCallback.h"

InsuranceAllConfirmSuiCallback::InsuranceAllConfirmSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void InsuranceAllConfirmSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
