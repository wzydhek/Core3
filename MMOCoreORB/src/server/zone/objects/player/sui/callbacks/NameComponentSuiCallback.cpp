#include "NameComponentSuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"

NameComponentSuiCallback::NameComponentSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void NameComponentSuiCallback::run(CreatureObject* player, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
