#include "ReactionFinePaymentSuiCallback.h"
#include "server/chat/ChatManager.h"
#include "server/zone/managers/reaction/ReactionManager.h"

ReactionFinePaymentSuiCallback::ReactionFinePaymentSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void ReactionFinePaymentSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
