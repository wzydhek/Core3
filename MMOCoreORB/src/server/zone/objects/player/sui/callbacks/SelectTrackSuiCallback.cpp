#include "SelectTrackSuiCallback.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"
#include "server/zone/objects/tangible/components/droid/DroidPlaybackModuleDataComponent.h"
#include "server/zone/objects/creature/ai/DroidObject.h"

SelectTrackSuiCallback::SelectTrackSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void SelectTrackSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
