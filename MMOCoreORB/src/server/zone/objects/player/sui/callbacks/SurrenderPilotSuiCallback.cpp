#include "SurrenderPilotSuiCallback.h"
#include "server/zone/objects/waypoint/WaypointObject.h"
#include "server/zone/objects/player/PlayerObject.h"

SurrenderPilotSuiCallback::SurrenderPilotSuiCallback(ZoneServer* server, uint32 factionHash) : SuiCallback(server) {
	faction = factionHash;
}

void SurrenderPilotSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
