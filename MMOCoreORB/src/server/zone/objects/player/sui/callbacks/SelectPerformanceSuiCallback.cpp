#include "SelectPerformanceSuiCallback.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"
#include "server/zone/managers/skill/Performance.h"

SelectPerformanceSuiCallback::SelectPerformanceSuiCallback(ZoneServer* server, int type, bool bandCmd) : SuiCallback(server) {
	performanceType = type;
	bandCommand = bandCmd;
}

void SelectPerformanceSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
