#include "CoaMessageFragmentSuiCallback.h"

CoaMessageFragmentSuiCallback::CoaMessageFragmentSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void CoaMessageFragmentSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
