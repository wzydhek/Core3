#include "SelectDroidEffectDelaySuiCallback.h"
#include "server/zone/objects/tangible/components/droid/DroidEffectsModuleDataComponent.h"
#include "server/zone/objects/creature/ai/DroidObject.h"

SelectDroidEffectDelaySuiCallback::SelectDroidEffectDelaySuiCallback(ZoneServer* serv, DroidEffectsModuleDataComponent* module, String effectName, int slotIndex) : SuiCallback(serv) {
	this->module = module;
	this->effectName = effectName;
	this->slotIndex = slotIndex;
}

void SelectDroidEffectDelaySuiCallback::run(CreatureObject* player, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
