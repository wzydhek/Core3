#include "JamUplinkSuiCallback.h"
#include "server/zone/Zone.h"

JamUplinkSuiCallback::JamUplinkSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void JamUplinkSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
