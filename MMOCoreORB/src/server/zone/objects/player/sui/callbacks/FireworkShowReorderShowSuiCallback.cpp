#include "FireworkShowReorderShowSuiCallback.h"

FireworkShowReorderShowSuiCallback::FireworkShowReorderShowSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void FireworkShowReorderShowSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
