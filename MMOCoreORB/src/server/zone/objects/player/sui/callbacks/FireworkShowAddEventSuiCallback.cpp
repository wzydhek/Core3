#include "FireworkShowAddEventSuiCallback.h"

FireworkShowAddEventSuiCallback::FireworkShowAddEventSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void FireworkShowAddEventSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
