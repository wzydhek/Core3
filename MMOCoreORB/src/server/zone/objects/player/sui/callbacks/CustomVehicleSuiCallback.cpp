#include "CustomVehicleSuiCallback.h"
#include "templates/customization/AssetCustomizationManagerTemplate.h"
#include "server/zone/objects/player/PlayerObject.h"

CustomVehicleSuiCallback::CustomVehicleSuiCallback(ZoneServer* serv, int palette, TangibleObject* kitTano) : SuiCallback(serv), numPalette(palette), customizationKit(kitTano) {
}

void CustomVehicleSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
