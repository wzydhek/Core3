#include "ShipTextureSuiCallback.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"

ShipTextureSuiCallback::ShipTextureSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void ShipTextureSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
