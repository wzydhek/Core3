#include "GrowablePlantSuiCallback.h"

GrowablePlantSuiCallback::GrowablePlantSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void GrowablePlantSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
