#include "DeleteAllItemsSuiCallback.h"

DeleteAllItemsSuiCallback::DeleteAllItemsSuiCallback(ZoneServer* serv) : SuiCallback(serv) {
}

void DeleteAllItemsSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
