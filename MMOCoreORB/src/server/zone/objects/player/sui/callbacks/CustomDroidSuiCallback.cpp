#include "CustomDroidSuiCallback.h"
#include "templates/customization/AssetCustomizationManagerTemplate.h"
#include "server/zone/objects/player/PlayerObject.h"

CustomDroidSuiCallback::CustomDroidSuiCallback(ZoneServer* serv, int palette, TangibleObject* kitTano) : SuiCallback(serv), numPalette(palette), customizationKit(kitTano) {
	setLoggingName("CustomDroidSuiCallback");
}

void CustomDroidSuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
