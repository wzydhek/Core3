#include "RenameCitySuiCallback.h"
#include "server/zone/ZoneProcessServer.h"
#include "server/zone/objects/player/PlayerObject.h"

RenameCitySuiCallback::RenameCitySuiCallback(Zone* zone, CityRegion* city) : SuiCallback(zone->getZoneServer()) {
	this->zne = zone;
	this->city = city;
}

void RenameCitySuiCallback::run(CreatureObject* creature, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
