#include "InsuranceMenuSuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"

InsuranceMenuSuiCallback::InsuranceMenuSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void InsuranceMenuSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
