#include "XpPurchaseSuiCallback.h"

XpPurchaseSuiCallback::XpPurchaseSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void XpPurchaseSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
