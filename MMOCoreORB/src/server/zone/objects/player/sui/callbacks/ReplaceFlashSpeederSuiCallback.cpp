#include "ReplaceFlashSpeederSuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"

ReplaceFlashSpeederSuiCallback::ReplaceFlashSpeederSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void ReplaceFlashSpeederSuiCallback::run(CreatureObject* player, SuiBox* sui, uint32 eventIndex, Vector<UnicodeString>* args) {
