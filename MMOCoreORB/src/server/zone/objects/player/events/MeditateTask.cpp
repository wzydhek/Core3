#include "MeditateTask.h"

MeditateTask::MeditateTask(CreatureObject* pl) {
	player = pl;
}

void MeditateTask::setMoodString(const String& ms) {
	moodString = ms;
}

String MeditateTask::getMoodString() {
	return moodString;
}

void MeditateTask::run() {
