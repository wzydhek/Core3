...
String AreaTrackTask::getDirection(CreatureObject* tracker, CreatureObject* trackee) {
	String direction;
...
String AreaTrackTask::getDistance(CreatureObject* tracker, CreatureObject* trackee) {
