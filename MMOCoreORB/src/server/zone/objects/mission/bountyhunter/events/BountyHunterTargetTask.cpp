#include "BountyHunterTargetTask.h"

BountyHunterTargetTask::BountyHunterTargetTask(MissionObject* mission, CreatureObject* player, const String& zoneName) : Logger("BountyHunterTargetTask") {
...
BountyHunterTargetTask::~BountyHunterTargetTask() {
}

void BountyHunterTargetTask::run() {
...
Vector3 BountyHunterTargetTask::getTargetPosition() {
	return currentPosition;
}

const String& BountyHunterTargetTask::getTargetZoneName() {
	return zoneName;
}

void BountyHunterTargetTask::updatePosition(CreatureObject* player) {
...
void BountyHunterTargetTask::updateToSpawnableTargetPosition() {
	ManagedReference<CreatureObject*> playerRef = player.get();
...
bool BountyHunterTargetTask::canSpawnTargetAt(const Vector3& position) {
	ManagedReference<CreatureObject*> playerRef = player.get();
