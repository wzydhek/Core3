#include "GuildChangeAbbrevResponseSuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"
#include "server/zone/objects/player/PlayerObject.h"

GuildChangeAbbrevResponseSuiCallback::GuildChangeAbbrevResponseSuiCallback(ZoneServer* server, GuildObject* guild) : SuiCallback(server) {
	guildObject = guild;
}

void GuildChangeAbbrevResponseSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
