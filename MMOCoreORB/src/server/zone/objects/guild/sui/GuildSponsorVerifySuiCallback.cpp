#include "GuildSponsorVerifySuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"

GuildSponsorVerifySuiCallback::GuildSponsorVerifySuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void GuildSponsorVerifySuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
