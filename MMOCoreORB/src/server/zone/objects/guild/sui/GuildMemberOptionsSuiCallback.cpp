#include "GuildMemberOptionsSuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"

GuildMemberOptionsSuiCallback::GuildMemberOptionsSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void GuildMemberOptionsSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
