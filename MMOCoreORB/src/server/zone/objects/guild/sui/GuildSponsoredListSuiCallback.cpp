#include "GuildSponsoredListSuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"
#include "server/zone/objects/player/sui/listbox/SuiListBox.h"

GuildSponsoredListSuiCallback::GuildSponsoredListSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void GuildSponsoredListSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
