#include "GuildCreateAbbrevResponseSuiCallback.h"
#include "server/zone/objects/player/PlayerObject.h"

GuildCreateAbbrevResponseSuiCallback::GuildCreateAbbrevResponseSuiCallback(ZoneServer* server) : SuiCallback(server) {
}

void GuildCreateAbbrevResponseSuiCallback::run(CreatureObject* player, SuiBox* suiBox, uint32 eventIndex, Vector<UnicodeString>* args) {
