#include "RemovePetsFromGroupTask.h"

RemovePetsFromGroupTask::RemovePetsFromGroupTask(CreatureObject* creo, GroupObject* grp) : player(creo), group(grp) {
}

void RemovePetsFromGroupTask::run() {
