...
SkillInfo::SkillInfo(const String& name, SkillInfo* parent) {
	skillName = name;
	parentSkill = parent;
...
SkillInfo::SkillInfo(const SkillInfo& si) : Object() {
...
SkillInfo& SkillInfo::operator=(const SkillInfo& si) {
	if (this == &si)
		return *this;
...
void SkillInfo::parseFromDataTableRow(DataTableRow* row) {
	try {
