...
DeleteCharactersTask::DeleteCharactersTask() : Task(), Logger("DeleteCharactersTask"), deletedCharacters(250, 250) {
	deletedCharacters.setNoDuplicateInsertPlan();

	setCustomTaskQueue("slowQueue");
}

void DeleteCharactersTask::run() {
...
void DeleteCharactersTask::updateDeletedCharacters() {
	ZoneServer* server = ServerCore::getZoneServer();
