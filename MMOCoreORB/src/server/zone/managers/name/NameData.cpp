...
NameData::NameData(const NameData& data) : Object() {
...
NameData& NameData::operator=(const NameData& data) {
	if (this == &data)
		return *this;
...
void NameData::readObject(LuaObject* luaObject) {
...
const NameRules* NameData::getFirstNameRules() const {
	return firstNameRules;
}

const NameRules* NameData::getLastNameRules() const {
	return lastNameRules;
}

String NameData::getRandomBeginningConsonant() const {
...
bool NameData::beginningConsonantContains(const String& fragment) const {
	return beginningConsonants.contains(fragment);
}

String NameData::getRandomMiddleConsonant() const {
...
bool NameData::middeConsonantContains(const String& fragment) const {
	return middleConsonants.contains(fragment);
}

String NameData::getRandomEndingConsonant() const {
...
bool NameData::endingConsonantContains(const String& fragment) const {
	return endingConsonants.contains(fragment);
}

String NameData::getRandomVowel() const {
...
bool NameData::vowelsContains(const String& fragment) const {
	return vowels.contains(fragment);
}

String NameData::getRandomSpecialSyllable() const {
...
String NameData::getRandomUniquePattern() const {
...
String NameData::getRandomUnique(const String& type, String& root) const {
...
bool NameData::specialSyllablesContains(const String& fragment) const {
