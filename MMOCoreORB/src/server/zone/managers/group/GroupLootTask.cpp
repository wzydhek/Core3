#include "GroupLootTask.h"
#include "server/zone/ZoneServer.h"
#include "server/zone/managers/player/PlayerManager.h"

GroupLootTask::GroupLootTask(GroupObject* gr, CreatureObject* pl, AiAgent* ai, bool all) {
	group = gr;
	player = pl;
	corpse = ai;
	lootAll = all;
...
void GroupLootTask::splitCredits() {
...
bool GroupLootTask::membersInRange() {
	for (int i = 0; i < group->getGroupSize(); ++i) {
