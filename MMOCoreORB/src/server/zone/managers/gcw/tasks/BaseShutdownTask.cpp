...
#include "BaseShutdownTask.h"
#include "server/zone/objects/player/PlayerObject.h"

BaseShutdownTask::BaseShutdownTask(GCWManager* gcwManager, BuildingObject* buildingObject, CreatureObject* creature, SceneObject* term) {
	gcwMan = gcwManager;
