#include "SecurityRepairTask.h"
#include "server/zone/ZoneServer.h"

SecurityRepairTask::SecurityRepairTask(GCWManager* gcwMan, TangibleObject* term, CreatureObject* player, int cnt) {
	gcwManager = gcwMan;
	terminal = term;
	creature = player;
	count = cnt;
