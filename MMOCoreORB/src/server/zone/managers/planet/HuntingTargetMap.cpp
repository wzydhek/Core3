#include "HuntingTargetMap.h"

HuntingTargetMap::HuntingTargetMap() {
	targets.setNoDuplicateInsertPlan();
}

void HuntingTargetMap::addTarget(const String& temp1, const String& temp2, int lev) {
	if (lev <= 0)
		return;
...
HuntingTargetEntry* HuntingTargetMap::getRandomTarget(int lev) {
