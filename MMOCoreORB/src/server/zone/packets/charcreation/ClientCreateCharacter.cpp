...
ClientCreateCharacter::ClientCreateCharacter(const UnicodeString& characterName, const String& templateName, float scaleFactor, const String& customAppearanceData, const String& hairTemplateName, const String& hairAppearanceData, const String& profession, const UnicodeString& biography, bool useNewbieTutorial) {
	insertShort(12);
