#include "UpdateTransformMessage.h"
#include "server/zone/objects/creature/CreatureObject.h"

UpdateTransformMessage::UpdateTransformMessage(SceneObject* scno) : BaseMessage(50) {
	insertShort(0x08);
...
UpdateTransformMessage::UpdateTransformMessage(SceneObject* scno, float posX, float posZ, float posY) : BaseMessage(50) {
	insertShort(0x08);
	insertInt(0x1B24F808);
	insertLong(scno->getObjectID());
...
void UpdateTransformMessage::parse(Packet* pack, SceneObject* scno) {
