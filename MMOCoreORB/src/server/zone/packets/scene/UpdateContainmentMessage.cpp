#include "UpdateContainmentMessage.h"

UpdateContainmentMessage::UpdateContainmentMessage(SceneObject* object, SceneObject* container, uint32 type) : BaseMessage(30) {
	uint64 parId = 0;
...
UpdateContainmentMessage::UpdateContainmentMessage(uint64 object, uint64 container, uint32 type) : BaseMessage(30) {
	insertShort(0x04);
	insertInt(0x56CBDE9E); // CRC
