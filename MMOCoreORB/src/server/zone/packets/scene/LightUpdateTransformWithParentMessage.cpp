#include "LightUpdateTransformWithParentMessage.h"
#include "server/zone/objects/creature/CreatureObject.h"

LightUpdateTransformWithParentMessage::LightUpdateTransformWithParentMessage(SceneObject* object) : UNRELIABLE_LIGHT_BASE_CLASS(50) {
	insertShort(0x08);
...
LightUpdateTransformWithParentMessage::LightUpdateTransformWithParentMessage(SceneObject* object, float posX, float posZ, float posY, uint64 cellID) : UNRELIABLE_LIGHT_BASE_CLASS(50) {
	insertShort(0x08);
	insertInt(0xC867AB5A);
	insertLong(cellID);
	insertLong(object->getObjectID());
