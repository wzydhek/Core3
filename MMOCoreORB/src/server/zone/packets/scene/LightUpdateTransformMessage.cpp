...
LightUpdateTransformMessage::LightUpdateTransformMessage(SceneObject* scno) : UNRELIABLE_LIGHT_BASE_CLASS(50) {
	insertShort(0x08);
...
LightUpdateTransformMessage::LightUpdateTransformMessage(SceneObject* scno, float posX, float posZ, float posY) : UNRELIABLE_LIGHT_BASE_CLASS(50) {
	insertShort(0x08);
	insertInt(0x1B24F808);
	insertLong(scno->getObjectID());
