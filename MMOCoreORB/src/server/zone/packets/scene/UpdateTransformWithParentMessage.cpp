#include "UpdateTransformWithParentMessage.h"
#include "server/zone/objects/creature/CreatureObject.h"

UpdateTransformWithParentMessage::UpdateTransformWithParentMessage(SceneObject* object) : BaseMessage(50) {
	insertShort(0x08);
...
UpdateTransformWithParentMessage::UpdateTransformWithParentMessage(SceneObject* object, float posX, float posZ, float posY, uint64 parentID) : BaseMessage(50) {
	insertShort(0x08);
	insertInt(0xC867AB5A);
	insertLong(parentID);
	insertLong(object->getObjectID());
