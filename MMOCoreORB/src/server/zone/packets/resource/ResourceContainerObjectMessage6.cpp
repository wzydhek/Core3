#include "ResourceContainerObjectMessage6.h"

ResourceContainerObjectMessage6::ResourceContainerObjectMessage6(ResourceContainer* rcno) : BaseLineMessage(rcno->getObjectID(), 0x52434E4F, 6, 0x05) {
