#include "GroupObjectMessage6.h"
#include "server/zone/objects/creature/CreatureObject.h"
#include "server/zone/objects/ship/ShipObject.h"
#include "server/zone/Zone.h"

GroupObjectMessage6::GroupObjectMessage6(GroupObject* gr) : BaseLineMessage(gr->getObjectID(), 'GRUP', 0x06, 0x08) {
...
void GroupObjectMessage6::insertMembers() {
