...
ChatOnCreateRoom::ChatOnCreateRoom(ChatRoom* room, int requestID, int error) : BaseMessage() {
...
void ChatOnCreateRoom::addToModeratorList(ChatRoom* room) {
...
void ChatOnCreateRoom::addToUserList(ChatRoom* room) {
...
ChatOnCreateRoom::ChatOnCreateRoom(CreatureObject* player, int requestID, int error) : BaseMessage() {
	insertShort(4);		   // Op Count
	insertInt(0x35D7CC9F); // Opcode
