#include "HarvesterResourceDataMessage.h"
#include "server/zone/managers/resource/ResourceManager.h"
#include "server/zone/Zone.h"

HarvesterResourceDataMessage::HarvesterResourceDataMessage(CreatureObject* player, InstallationObject* hino, Zone* zone) : ObjectControllerMessage(player->getObjectID(), 0x0B, 0xEA) {
...
void HarvesterResourceDataMessage::insertResourceList(Vector<ManagedReference<ResourceSpawn*>>* list, InstallationObject* hino) {
