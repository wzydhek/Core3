#include "ShipUpdateTransformCallback.h"
...
ShipUpdateTransformCallback::ShipUpdateTransformCallback(ZoneClientSession* client, ZoneProcessServer* server) : MessageCallback(client, server) {
	shipId = 0;
...
void ShipUpdateTransformCallback::parse(Message* message) {
...
void ShipUpdateTransformCallback::run() {
...
bool ShipUpdateTransformCallback::isPositionValid() const {
...
bool ShipUpdateTransformCallback::isPositionUpdate(ShipObject* ship) const {
...
bool ShipUpdateTransformCallback::isStaticUpdate(ShipObject* ship) {
...
void ShipUpdateTransformCallback::updateCollision(ShipObject* ship, CreatureObject* pilot, const Vector3& collisionPoint) {
#ifdef SHIP_TRANSFORM_DEBUG
...
void ShipUpdateTransformCallback::updatePosition(ShipObject* ship, CreatureObject* pilot) {
...
void ShipUpdateTransformCallback::updateStatic(ShipObject* ship, CreatureObject* pilot) {
	const Vector3& position = ship->getPosition();
...
void ShipUpdateTransformCallback::synchronize(ShipObject* ship, CreatureObject* pilot) {
	const Vector3& position = ship->getPosition();
...
void ShipUpdateTransformCallback::updateTransform(ShipObject* ship, const Vector3& position, bool reorthonormalize) {
...
void ShipUpdateTransformCallback::broadcastTransform(ShipObject* ship, const Vector3& position) {
...
void ShipUpdateTransformCallback::updateError(CreatureObject* pilot, const String& message, bool bounceBack) {
	if (!message.isEmpty()) {
...
#ifdef SHIP_TRANSFORM_DEBUG
void ShipUpdateTransformCallback::sendDebug(CreatureObject* pilot, ShipObject* ship, const String& message, const Vector3& position) {
	if (sendText) {
...
void ShipUpdateTransformCallback::sendDebugMessage(CreatureObject* pilot, ShipObject* ship, const String& message, const Vector3& position) {
	StringBuffer msg;
...
void ShipUpdateTransformCallback::sendDebugPath(CreatureObject* pilot, ShipObject* ship, const Vector3& nextPosition) {
