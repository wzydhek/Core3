#include "ManufactureSchematicObjectMessage6.h"

ManufactureSchematicObjectMessage6::ManufactureSchematicObjectMessage6(uint64 oid, uint32 schematicCRC, bool activeCraft) : BaseLineMessage(oid, 0x4D53434F, 6, 0x07) {
