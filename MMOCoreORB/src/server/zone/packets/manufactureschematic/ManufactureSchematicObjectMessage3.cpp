#include "ManufactureSchematicObjectMessage3.h"

ManufactureSchematicObjectMessage3::ManufactureSchematicObjectMessage3(uint64 oid, float complexity, String playerName) : BaseLineMessage(oid, 0x4D53434F, 3, 0x09) {
...
ManufactureSchematicObjectMessage3::ManufactureSchematicObjectMessage3(ManufactureSchematic* manufactureSchematic, String playerName) : BaseLineMessage(manufactureSchematic->getObjectID(), 0x4D53434F, 3, 0x09) {
