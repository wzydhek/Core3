#include "CraftingExperimentCallback.h"
...
CraftingExperimentCallback::CraftingExperimentCallback(ObjectControllerMessageCallback* objectControllerCallback) : MessageCallback(objectControllerCallback->getClient(), objectControllerCallback->getServer()), clientCounter(0), numRowsAttempted(0), objectControllerMain(objectControllerCallback) {
}

void CraftingExperimentCallback::parse(Message* message) {
	message->parseInt();
...
void CraftingExperimentCallback::run() {
