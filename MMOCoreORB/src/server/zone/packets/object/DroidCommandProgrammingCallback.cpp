#include "DroidCommandProgrammingCallback.h"
...
DroidCommandProgrammingCallback::DroidCommandProgrammingCallback(ObjectControllerMessageCallback* objectControllerCallback) : MessageCallback(objectControllerCallback->getClient(), objectControllerCallback->getServer()), objectControllerMain(objectControllerCallback), controlDeviceID(0) {
}

void DroidCommandProgrammingCallback::parse(Message* message) {
...
void DroidCommandProgrammingCallback::run() {
...
void DroidCommandProgrammingCallback::addCommand(ZoneServer* zoneServer, SceneObject* datapad, Ability* ability, float dataSize) {
...
void DroidCommandProgrammingCallback::addModuleFromInventory(ZoneServer* zoneServer, SceneObject* datapad, DroidProgrammingChip* programmedModule) {
...
bool DroidCommandProgrammingCallback::hasCommand(SceneObject* datapad, String commandName) {
	if (datapad == nullptr) {
		return false;
	}
...
bool DroidCommandProgrammingCallback::hasSpaceForCommand(SceneObject* datapad, int capacity, int commandSize) {
	if (datapad == nullptr) {
		return false;
	}
