#include "ShowFlyText.h"

ShowFlyText::ShowFlyText(SceneObject* creo, const String& file, const String& aux, uint8 red, uint8 green, uint8 blue, float size) : ObjectControllerMessage(creo->getObjectID(), 0x1B, 0x1BD) {
