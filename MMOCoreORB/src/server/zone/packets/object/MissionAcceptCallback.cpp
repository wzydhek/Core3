#include "MissionAcceptCallback.h"
...
MissionAcceptCallback::MissionAcceptCallback(ObjectControllerMessageCallback* objectControllerCallback) : MessageCallback(objectControllerCallback->getClient(), objectControllerCallback->getServer()), missionObjectID(0), terminalObjectID(0), terminalIndex(0), objectControllerMain(objectControllerCallback) {
}

void MissionAcceptCallback::parse(Message* message) {
...
void MissionAcceptCallback::run() {
