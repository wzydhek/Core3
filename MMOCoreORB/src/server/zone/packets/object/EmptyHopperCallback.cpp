#include "EmptyHopperCallback.h"
#include "server/zone/managers/resource/ResourceManager.h"
#include "GenericResponse.h"
#include "server/zone/packets/harvester/HarvesterObjectMessage7.h"
#include "server/zone/objects/transaction/TransactionLog.h"

EmptyHopperCallback::EmptyHopperCallback(ObjectControllerMessageCallback* objectControllerCallback) : MessageCallback(objectControllerCallback->getClient(), objectControllerCallback->getServer()), harvesterId(0), resourceId(0), quantity(0), byte1(0), byte2(0), objectControllerMain(objectControllerCallback) {
}

void EmptyHopperCallback::parse(Message* message) {
