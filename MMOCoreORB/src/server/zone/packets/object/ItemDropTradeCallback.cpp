#include "ItemDropTradeCallback.h"
...
ItemDropTradeCallback::ItemDropTradeCallback(ObjectControllerMessageCallback* objectControllerCallback) : MessageCallback(objectControllerCallback->getClient(), objectControllerCallback->getServer()), targetToTrade(0), objectControllerMain(objectControllerCallback) {
}

void ItemDropTradeCallback::parse(Message* message) {
...
void ItemDropTradeCallback::run() {
