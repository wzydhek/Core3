#include "NpcConversationMessage.h"

NpcConversationMessage::NpcConversationMessage(CreatureObject* creo, const UnicodeString& message) : ObjectControllerMessage(creo->getObjectID(), 0x0B, 0xDF) {
...
NpcConversationMessage::NpcConversationMessage(CreatureObject* creo, StringIdChatParameter& stringid) : ObjectControllerMessage(creo->getObjectID(), 0x0B, 0xDF) {
