...
DataTransform::DataTransform(SceneObject* sceneO) : ObjectControllerMessage(sceneO->getObjectID(), 0x1B, 0x71) {
...
DataTransform::DataTransform(SceneObject* sceneO, const Vector3& position) : ObjectControllerMessage(sceneO->getObjectID(), 0x1B, 0x71) {
	insertInt(sceneO->getMovementCounter());
...
DataTransformCallback::DataTransformCallback(ObjectControllerMessageCallback* objectControllerCallback) : MessageCallback(objectControllerCallback->getClient(), objectControllerCallback->getServer()) {
...
void DataTransformCallback::parse(Message* message) {
...
void DataTransformCallback::updateError(CreatureObject* creO, const String& message, bool bounceBack, float bounceDistance) const {
...
void DataTransformCallback::run() {
...
void DataTransformCallback::updatePosition(CreatureObject* creO, SceneObject* parent) {
...
void DataTransformCallback::updateStatic(CreatureObject* creO, SceneObject* parent) {
...
void DataTransformCallback::updateTransform(CreatureObject* creO, SceneObject* parent, const Vector3& position) const {
