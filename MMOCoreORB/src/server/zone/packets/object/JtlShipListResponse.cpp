...
JtlShipListResponse::JtlShipListResponse(CreatureObject* player, SceneObject* terminal) : ObjectControllerMessage(player->getObjectID(), 0x1B, 0x41D) {
	if (player == nullptr)
		return;
