#include "PlayersNearYou.h"
#include "server/zone/objects/player/PlayerObject.h"
#include "server/zone/managers/planet/PlanetManager.h"
#include "server/zone/objects/guild/GuildObject.h"

PlayersNearYouMessage::PlayersNearYouMessage(CreatureObject* creo) : ObjectControllerMessage(creo->getObjectID(), 0x0B, 0x1E7) {
	insertInt(0); // No players.
}

void PlayersNearYouMessage::addFoundPlayer(CreatureObject* player) {
	// Player Bitmasks
...
void PlayersNearYouMessage::insertPlayerCounter(uint32 foundCount) {
