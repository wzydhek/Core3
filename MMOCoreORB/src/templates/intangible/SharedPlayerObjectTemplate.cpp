...
void SharedPlayerObjectTemplate::readObject(IffStream* iffStream) {
...
void SharedPlayerObjectTemplate::readObject(LuaObject* templateData) {
...
void SharedPlayerObjectTemplate::parseVariableData(const String& varName, LuaObject* templateData) {
...
const SortedVector<String>* SharedPlayerObjectTemplate::getPlayerDefaultGroupPermissions() const {
